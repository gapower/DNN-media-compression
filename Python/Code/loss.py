"""
File containing custom loss functions. Note on loss functions: PSNR/MSE values output during training may be
inconsistent - This can happen due to Micro-averaging and Macro-averaging nad is not indicative on an error/misscalculation
"""
