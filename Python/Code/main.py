    ...
    **kwargs,
    ...
    if not loaded_model or continue_training:
        ...
        if loaded_model:
            ...
            model.load_weights("/content/drive/My Drive/Fifth Year/MAI/Databases/Out/GP_3D_1/sub_640p/LowQual/optimiser=Adam_epochs=14_batch_size=1_lr=0.00019143/Model/GP_3D_1_weights.h5")
