...
class GP_3D(ModelClass):
    ...
    def build(self):
        ...
        conv5_1 = Conv3DTranspose(filters=27, kernel_size=(2, 3, 3), activation="relu")(zpad3)
        conv5_2 = Conv3DTranspose(filters=27, kernel_size=(2, 3, 3), activation="relu")(zpad3)
        ...
        conv6_1 = Conv3DTranspose(filters=9, kernel_size=(2, 3, 3), activation="relu")(zpad4)
        conv6_2 = Conv3DTranspose(filters=9, kernel_size=(2, 3, 3), activation="relu")(zpad4)
        merge6 = concatenate([conv6_1, conv6_2], axis=1)

        zpad5 = ZeroPadding3D(padding=(0, 1, 1))(merge6)
        conv7_1 = Conv3DTranspose(filters=1, kernel_size=(2, 3, 3), activation="relu")(zpad5)
        conv7_2 = Conv3DTranspose(filters=1, kernel_size=(2, 3, 3), activation="relu")(zpad5)
